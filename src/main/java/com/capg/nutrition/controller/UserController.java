...
import com.capg.nutrition.services.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> getUserByUserId(@PathVariable("userId") int id) throws InvalidDataException  {
    ...
    public ResponseEntity<String> deleteUser(@PathVariable int id) throws InvalidDataException {
    ...
    public ResponseEntity<String> updateUser(@PathVariable int id , @RequestBody UserDTO user) throws InvalidDataException{
